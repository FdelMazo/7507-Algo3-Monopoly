...
public class BarrioDobleTest {
    ...
    public void testDosBarriosPertenecenAlMismoJugadorEsTrue(){
        ...
        ArrayList<Edificacion> listaHoteles = new ArrayList();
